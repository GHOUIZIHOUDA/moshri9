        ...
        <br><br><div>
            <div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="container">           
                            <table class="myTable table table-striped table-responsive">
                                <thead class="">
                                    <tr>
                                      <th>ID</th>
                                      <th>Secteur</th>
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <td name="id"><b>{{$sect->id}}</b></td>
                                    <td name="secteur"><b>{{$sect->secteur}}</b></td>
                                    <td><button class="btn btn-danger" ><a href = '/secteur/delete/{{ $sect->id }}' style="text-decoration:none; color:#ffffff;">Delete</a></button></td>                            
                                  </tr>
                                  @endforeach
                                </tbody>
                            </table>
    ...
    <div class="modal-dialog col-md-8">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class=" mb-6" action="{{route('secteur')}}" method="POST">
                @csrf
                    <div class="form-group">
                        <label for="inputSecteur">Secteur</label>
                        <input type="text" class="form-control" id="inputSecteur" placeholder="Secteur" name="secteur">
                    </div>
